...
## Key Features
*	**Cloud API:** Utilizes the OpenAI Python SDK routed through GitHub Models (`openai/gpt-4o-mini`). Includes direct exception handling for HTTP 429 Rate Limit errors and token quota limits.
